...
namespace representation {
    ...
    shared_ptr<Player>& ConcreteFactory::getPlayer() {
        return m_player;
    }

    shared_ptr<Score>& ConcreteFactory::getScore() {
        return m_score;
    }

    vector<shared_ptr<Platform>>& ConcreteFactory::getPlatforms() {
        return m_platforms;
    }

    vector<shared_ptr<BG_Tile>>& ConcreteFactory::getBG_Tiles() {
        return m_BG_Tiles;
    }

    vector<shared_ptr<Bonus>>& ConcreteFactory::getBonussen() {
        return m_bonussen;
    }
