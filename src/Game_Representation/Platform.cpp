...
namespace representation {
    ...
    Platform_vertical::Platform_vertical(shared_ptr<logic::Platform_L> platform, string image) : Platform(move(platform), image) {}

    Platform_vertical::~Platform_vertical() {}

    Platform_horizontal::Platform_horizontal(shared_ptr<logic::Platform_L> platform, string image) : Platform(move(platform), image) {}

    Platform_horizontal::~Platform_horizontal() {}

    Platform_temporary::Platform_temporary(shared_ptr<logic::Platform_L> platform, string image) : Platform(move(platform), image) {}
